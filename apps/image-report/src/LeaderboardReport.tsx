...
function CompactRankRow({ entry, period }: { entry: LeaderboardEntry; period: string; key?: any }) {
...
function FullRankRow({ entry, period }: { entry: LeaderboardEntry; period: string; key?: any }) {
  const isTop3 = entry.rank <= 3;
