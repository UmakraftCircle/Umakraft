...
export const linkCommand = new SlashCommandBuilder()
  .setName('link')
  .setDescription('Manage Discord ↔ Umamusume trainer links or submit a link request')
  .addSubcommand((sub) =>
    sub.setName('request').setDescription('Request trainer linking (bot will DM you to collect details)')
  )
  .addSubcommand((sub) =>
...
export const fanGainSlashCommand = new SlashCommandBuilder()
  .setName('fan-gain')
  .setDescription('View your current fan gain report')
  .setDMPermission(true)
  .toJSON();

export const fanLeaderboardSlashCommand = new SlashCommandBuilder()
  .setName('fan-leaderboard')
  .setDescription('View top fan leaderboard')
  .addStringOption((opt) =>
    opt.setName('circle').setDescription('Which circle to rank').setRequired(false)
      .addChoices({ name: 'Umakraft', value: 'umakraft' }, { name: 'UmaKraft 2', value: 'umakraft2' }, { name: 'Unified', value: 'unified' })
  )
...
export const rankSlashCommand = new SlashCommandBuilder()
  .setName('rank')
  .setDescription('View your current leaderboard rank')
  .setDMPermission(true)
  .toJSON();

export const milestoneSlashCommand = new SlashCommandBuilder()
  .setName('milestone')
  .setDescription('View monthly milestone award status and historical awards')
  .setDMPermission(true)
  .toJSON();

export const paceSlashCommand = new SlashCommandBuilder()
  .setName('pace')
  .setDescription('View your current fan pace, deficit, and surplus progress report')
  .setDMPermission(true)
  .toJSON();

export const helpSlashCommand = new SlashCommandBuilder()
  .setName('help')
  .setDescription('Show Umakraft Discord automation help and commands')
  .setDMPermission(true)
  .toJSON();
...
export const ALL_COMMANDS = [
  ...
  unscheduleCommand,
  fanGainSlashCommand,
  fanLeaderboardSlashCommand,
  rankSlashCommand,
  milestoneSlashCommand,
  paceSlashCommand,
  helpSlashCommand,
];
