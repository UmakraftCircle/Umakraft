...
/**
 * Feature 2: read-only, allow-listed tools for the /ask agent.
 * These live in the Discord app because they span both the fan-tracker
 * domain (fanTrackerAPI) and integrations (trainerLinkStore). All are
 * side-effect free; the model may only invoke them by slug, never run
