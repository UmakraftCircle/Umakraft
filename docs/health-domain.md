...
pnpm workspaces, Node HTTP API, PandaStack deployment, and in-memory/runtime
...
| GET | `/status` | Overall uptime and service status |
...
container probes (such as PandaStack).
