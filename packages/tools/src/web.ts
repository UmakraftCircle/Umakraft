...
export const webFetchCapability: ToolCapability = {
  id: 'web-fetch',
  category: 'Web',
...
export const webSearchCapability: ToolCapability = {
  id: 'web-search',
  category: 'Web',
...
/**
 * Creates an isolated, disposable instance of the Web Fetch tool.
 */
export function createWebFetch(): DisposableToolInstance {
  let isDisposed = false;
  return {
    slug: webFetchCapability.id,
    name: webFetchCapability.name!,
    description: webFetchCapability.description,
    parameters: webFetchCapability.parameters!,
    ...
    dispose: () => {
      isDisposed = true;
      logger.debug('Disposed web-fetch instance');
    },
    handler: async (args) => {
      if (isDisposed) {
        throw new Error('Cannot execute disposed tool instance: web-fetch');
      }
...
/**
 * Creates an isolated, disposable instance of the Web Search tool.
 */
export function createWebSearch(): DisposableToolInstance {
  let isDisposed = false;
  return {
    slug: webSearchCapability.id,
    name: webSearchCapability.name!,
    description: webSearchCapability.description,
    parameters: webSearchCapability.parameters!,
    ...
    dispose: () => {
      isDisposed = true;
      logger.debug('Disposed web-search instance');
    },
    handler: async (args) => {
      if (isDisposed) {
        throw new Error('Cannot execute disposed tool instance: web-search');
      }
 ...
 */
export const webFetch: DisposableToolInstance = createWebFetch();
 ...
 */
export const webSearch: DisposableToolInstance = createWebSearch();

export const webTools = [webFetch, webSearch];

export const webCapabilities: ToolCapability[] = [
  webFetchCapability,
  webSearchCapability
];

export const webRegistrations: ToolCapabilityRegistration[] = [
  { capability: webFetchCapability, factory: createWebFetch },
  { capability: webSearchCapability, factory: createWebSearch }
];
