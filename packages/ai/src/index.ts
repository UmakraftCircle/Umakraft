...
export class MockAIService extends AIService {
  ...
  public override async generateStructuredOutput(options: GenerateOptions): Promise<any> {
    ...
    if (promptLower.includes('plan') || systemLower.includes('planner')) {
      return {
        tasks: [
          {
            id: 'task-fetch',
            name: 'Fetch Statistics & Metrics',
            toolSlug: 'fan-tracker-fetch-stats',
            arguments: { trainerId: 'T-982314' },
            dependencies: [],
            layer: 0,
            maxRetries: 3
          },
          {
            ...
            arguments: { trainerId: 'T-982314', period: 'weekly' },
